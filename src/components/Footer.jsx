...
const Footer = () => {
  return (
    <div className=" bg-black/90 text-white rounded-t-3xl mt-8 md:mt-0">
      <div className="flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
        <div className=" w-full md:w-1/4">
          <h1 className=" font-semibold text-xl pb-4">22</h1>
          <p className=" text-[14px] font-[100] leading-7">
        ...
        <div>
          ...
          <nav className=" text-[14px] font-[200] flex flex-col gap-2">
            <Link
              to="about"
              spy={true}
              smooth={true}
